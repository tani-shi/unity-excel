...
namespace UnityMasterData.Libs
{
    ...
    public class Excel
    {
        ...
        /// <summary>
        /// The error details when failed reading. If null or empty, it was read successfully.
        /// </summary>
        public string error
        {
            get
        ...
        /// <returns>A parsed instance if successfully to read; otherwise an empty instance(non-null).</returns>
